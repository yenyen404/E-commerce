...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if($total_order > $current_stock){
        echo "<script>alert('order exceeds available stocks! Only {$current_stock} left.');window.location.href='home.php'</script>";
        ...
        // insert order
        $sql_insert = "INSERT INTO orders (order_id, product_id, product_name, price, total_order, total_price, user_name, user_number, user_address) VALUE ('$next_order_id', '$product_id', '$product_name', '$price', '$total_order', '$total_price', '$user_name', '$user_number', '$user_address')";
